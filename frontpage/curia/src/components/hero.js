    ...
    <section className="relative flex items-start justify-end bg-transparent text-[--background] py-8 min-[370px]:py-16 h-[28rem] max-h-[28rem]">
      <div className="flex flex-col items-center md:items-end text-center z-10">
        ...
        <div className="flex items-center justify-between space-x-4">
          <button onClick={() => window.location.assign("https://app.curiachronos.ro/auth/signup")} className="bg-[--background] text-[--foreground] px-8 py-4 text-md rounded-lg transition-colors duration-400">
            Începe acum
          </button>
        </div>
      </div>
